...
fun org.cryptobiotic.protogen.ElectionInitialized.import(group: GroupContext, errs: ErrorMessages): ElectionInitialized? {
...
private fun org.cryptobiotic.protogen.Guardian.import(group: GroupContext, errs: ErrorMessages) : Guardian? {
...
fun ElectionInitialized.publishProto() =
    org.cryptobiotic.protogen.ElectionInitialized(
        ...
        this.metadata.entries.map { org.cryptobiotic.protogen.ElectionInitialized.MetadataEntry(it.key, it.value) }
    )

private fun Guardian.publishProto() =
    org.cryptobiotic.protogen.Guardian(
        this.guardianId,
        this.xCoordinate,
