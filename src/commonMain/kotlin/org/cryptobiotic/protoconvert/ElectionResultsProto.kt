...
fun org.cryptobiotic.protogen.TallyResult.import(group: GroupContext, errs : ErrorMessages): TallyResult? {
...
fun org.cryptobiotic.protogen.DecryptionResult.import(group: GroupContext, errs : ErrorMessages): DecryptionResult? {
